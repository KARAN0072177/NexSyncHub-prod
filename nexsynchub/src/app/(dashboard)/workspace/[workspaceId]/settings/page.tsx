        ...
        <div className="bg-gray-900/40 border border-gray-800 rounded-2xl p-6 mb-6">
          ...
          <div className="space-y-4">
            ...
            <button
              ...
              className="flex items-center gap-2 px-5 py-3 rounded-xl bg-indigo-600 hover:bg-indigo-700 text-white"
            >
              ...
              >
                ...
                <div className="flex gap-2">
                  ...
                  <button
                    ...
                    className="px-3 py-1.5 rounded-lg bg-gray-700 text-gray-200 text-sm"
                  >
                    Rename
                  </button>
