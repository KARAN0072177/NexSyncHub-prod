  ...
  return (
    <div className="min-h-screen" style={{ background:T.bg, color:T.text }}>
      ...
      <div className="fixed inset-0 pointer-events-none overflow-hidden" aria-hidden>
        ...
        <div style={{ position:"absolute", inset:0, backgroundImage:"linear-gradient(rgba(99,140,255,0.06) 1px,transparent 1px),linear-gradient(90deg,rgba(99,140,255,0.06) 1px,transparent 1px)", backgroundSize:"48px 48px" }} />
      </div>
