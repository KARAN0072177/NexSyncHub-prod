...
export default function WorkspaceCreationControl() {
  ...
  useEffect(() => {
    const fetchSettings = async () => {
      try {
        ...
        if (res.ok) {
          setEnabled(data.settings.allowWorkspaceCreation);
        }
      } catch (error) {
        console.error(error);
      } finally {
  ...
  const handleToggle = async () => {
    try {
      ...
      const res = await fetch("/api/admin/platform-settings", {
        ...
        body: JSON.stringify({ allowWorkspaceCreation: newValue }),
      });
      ...
      if (!res.ok) {
        ...
        showToast(
          newValue
            ? "Workspace creation is now allowed."
            : "Workspace creation is now disabled.",
          "success"
        );
      }
    } catch (error) {
    ...
    <div className="relative mt-6">
      ...
      >
        ...
        <div
          ...
          style={{
            background: `linear-gradient(90deg, transparent, ${enabled ? T.emerald : T.rose}, transparent)`,
          }}
        />
        ...
        <div className="relative z-10 flex flex-col sm:flex-row sm:items-start justify-between gap-8">
          <div className="flex items-start gap-5">
            ...
            >
              {enabled ? (
                <Building2 size={24} style={{ color: T.emerald }} />
              ) : (
                <Lock size={24} style={{ color: T.rose }} />
              )}
            ...
            <div>
              ...
              <p
                ...
                style={{ color: T.muted }}
              >
                Control whether users can create new workspaces on the
                platform. Disabling this prevents any new workspace from being
                created globally.
              </p>
              ...
              <div className="mt-5">
                ...
                >
                  ...
                  />
                  {enabled ? "Creation Allowed" : "Creation Blocked"}
                </span>
              </div>
            </div>
          </div>
          ...
          <button
            ...
            style={{
              ...
              backdropFilter: "blur(8px)",
              border: `1px solid ${enabled ? "transparent" : "rgba(255,255,255,0.15)"}`,
              opacity: saving ? 0.7 : 1,
            }}
            aria-label={
              enabled ? "Disable workspace creation" : "Enable workspace creation"
            }
          >
            <motion.div
            ...
            >
              ...
              >
                ...
                <div>
                  ...
                  >
                    Workspace creation is strictly disabled
                  </p>
                  <p
                    className="text-sm leading-relaxed"
                    style={{ color: "rgba(255,255,255,0.7)" }}
                  >
                    Users will no longer be able to create new workspaces until
                    this setting is re-enabled. Existing workspaces will
